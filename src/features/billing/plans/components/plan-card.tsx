  ...
  return (
    <Card
      className={`relative flex flex-col overflow-hidden rounded-2xl transition-all duration-300 ${
        popular
          ? 'bg-zinc-900 text-white border-0 ring-2 ring-violet-500 shadow-xl shadow-violet-500/10 hover:shadow-2xl hover:shadow-violet-500/20'
          : 'bg-card border border-border hover:shadow-lg hover:border-zinc-300 dark:hover:border-zinc-600'
      }`}
    >
      {/* Popular badge */}
      {popular && (
        <div className='absolute -top-0 left-1/2 -translate-x-1/2 z-10'>
          <span className='inline-flex items-center gap-1 rounded-b-lg bg-violet-500 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-white shadow-lg shadow-violet-500/30'>
